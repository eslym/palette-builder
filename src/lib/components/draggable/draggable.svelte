<script lang="ts" module>
	...
	function createDragView(snippet: Component<ViewProps>, props: ViewProps) {
...
<script lang="ts">
	import { mount, onDestroy, unmount, type Component, type Snippet } from 'svelte';
	...
	const DraggingView = componentize<ViewProps>(draggingView);
